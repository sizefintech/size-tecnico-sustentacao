...
{   
    ...
    public class CatalogoRecebiveisContextFactory : IDesignTimeDbContextFactory<CatalogoRecebiveisContext>
    {
        public CatalogoRecebiveisContext CreateDbContext(string[] args)
        {
            ...
            var optionsBuilder = new DbContextOptionsBuilder<CatalogoRecebiveisContext>();
            ...
            return new CatalogoRecebiveisContext(optionsBuilder.Options, notificador);
        }
    }
}
